...
int varmistusnum (string viesti) {
    int numero;
    while (true) {
        cout << viesti;
        cin >> numero;
...
int main() {
    ...
    while (true) {  // pääsilmukka
       ...
       cout << RED << "===========================================\n";
        ...
        vastaus1 = varmistusnum(""); // varmistaa että annettu asia on numero
        ...
        if (vastaus1 == 1) {
            ...
            cout << RED << "===========================================\n";
            int yot;
            yot = varmistusnum(""); // varmistaa taas että ei annettu kirjamia
